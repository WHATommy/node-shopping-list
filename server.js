...
const {ShoppingList, Recipies} = require('./models');
...
Recipes.create('Scramble Eggs on Toast', ['Sourdough bread', '3 eggs', '3 tbs of milk', 'half a stick of butter' ]);
